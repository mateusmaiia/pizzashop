...
export function AccountMenu() {
  ...
  const { mutateAsync: SignOutFn, isPending: SingnOutPending } = useMutation({
    mutationFn: SignOut,
    onSuccess() {
      // replace: true, leva o usuário para uma nova rota impossibilitando de clicar no botão voltar e voltar para o Dashboard.
